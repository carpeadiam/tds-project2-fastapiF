...
def use_github():
    ...
    return "https://raw.githubusercontent.com/carpeadiam/iitm1tds/refs/heads/main/email.json"
...
def host_your_portfolio_on_github_pages(email):
    urls = {
        ...
        "24f2000074@ds.study.iitm.ac.in":"https://carpeadiam.github.io/", #Adi
    }
    answer = urls[email]
    return answer
...
def use_google_colab(email):
    results = {
        ...
        "24f2000074@ds.study.iitm.ac.in":"3b454", #Adi
...
def create_a_scheduled_github_action(
    repo_owner="carpeadiam",           
    repo_name="iitmgactions",               
    token={os.getenv("GITHUB_ACTION_TOKEN")},  # Set default to required token
    email="24f2000074@ds.study.iitm.ac.in",  # Set default to required email
    cron="30 2 * * *",                   
    workflow_name="blank2.yml"     
):
    # GitHub API base URL
